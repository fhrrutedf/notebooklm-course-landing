...
const additionalSamples = [
  {
    ...
    badge: 'ملاحظات مكتوبة بخط اليد تحوّلت إلى درس منظم',
  },
  {
    ...
    tag: 'قصة وتطبيق شفهي',
    badge: 'نشاط صفّي جاهز للطباعة والتطبيق المباشر',
  },
  {
    ...
    tag: 'شرح درس بصري',
    badge: 'خريطة بصرية تختصر الدرس في صفحة واحدة',
  },
]
    ...
    <div dir="rtl" className="min-h-screen bg-[#F8F8F6] text-[#242424]" style={{ fontFamily: 'var(--font-ibm-plex-sans-arabic), sans-serif' }}>
      <nav className="sticky top-0 z-50 border-b border-[#E2E2DF] bg-[#F8F8F6]/95 px-4 py-4 backdrop-blur">
        <div className="mx-auto flex max-w-[1180px] items-center justify-between gap-3">
          ...
          <a href={createWhatsAppLink('مرحباً، شاهدت صفحة النماذج وأريد تفاصيل التسجيل في الكورس.')} onClick={() => { track('whatsapp_click', { source: 'results_nav', affiliate_ref: affiliateRef || 'direct' }); trackWhatsApp('results_nav' as any, { affiliate_ref: affiliateRef || 'direct' }) }} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-full bg-[#E3342F] px-5 py-2.5 text-sm font-bold text-white hover:bg-[#B92723]">اطلب التفاصيل <MessageCircle className="h-4 w-4" /></a>
        </div>
      </nav>
      ...
      <header className="border-b border-[#E2E2DF] bg-[#F7EDEC]">
        <div className="mx-auto max-w-[1180px] px-5 py-16 md:px-8 md:py-24">
          ...
          <p className="mt-6 max-w-3xl text-base leading-[2] text-[#666666] md:text-xl">من مصدرك بتطلع شرح، اختبار، عرض تقديمي، خريطة ذهنية ومحتوى مرتب. هاي نماذج عملية بتفرجيك كيف بينتقل المعلم من الشغل المتكرر إلى مخرجات جاهزة للاستخدام.</p>
        </div>
      </header>
