...
export default function LandingPage() {
  ...
  const bonuses = [
    { title: 'ساعة مجانية: كيف تكتب Prompts', subtitle: 'Bonus Training', oldValue: 'قيمة إضافية', value: 'مجانًا مع التسجيل', desc: 'تدريب إضافي في نهاية الكورس يعلّمك كيف تكتب Prompt واضحًا، وتطوّره حسب الصف والمادة والنتيجة التي تريدها.', icon: Zap },
    { title: '4 جلسات مباشرة مع متابعة شخصية', subtitle: 'Live Support', oldValue: '', value: 'ضمن تجربة الكورس', desc: 'أربع جلسات مباشرة للعمل على الأسئلة ومراجعتها، مع متابعة شخصية من المدرب أثناء التطبيق.', icon: Users },
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'الكورس مدته 5 ساعات ونصف، وهو برنامج مسجل ومنظم، وترافقه 4 جلسات مباشرة للعمل على الأسئلة ومراجعتها، مع متابعة شخصية من المدرب أثناء التطبيق.',
    },
    {
      q: 'كم مدة الكورس؟ وهل توجد جلسات مباشرة؟',
      a: 'مدة المحتوى المسجل 5 ساعات ونصف. نعم، توجد 4 جلسات مباشرة مخصصة للعمل على الأسئلة ومراجعتها، إضافة إلى متابعة شخصية من المدرب.',
    },
    {
